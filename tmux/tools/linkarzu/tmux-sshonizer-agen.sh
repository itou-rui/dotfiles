...
# Filename: ~/.config/tmux/tools/linkarzu/tmux-sshonizer-agen.sh
...
if [[ $# -eq 1 ]]; then
	...
	~/.config/tmux/tools/linkarzu/ssh-select.sh
...
# will work
mappings_file="$HOME/.config/tmux/tools/linkarzu/karabiner-mappings.sh"
