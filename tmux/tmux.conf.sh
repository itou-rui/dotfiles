# Filename: ~/.config/tmux/tmux.conf.sh
# ~/.config/tmux/tmux.conf.sh
...
daily_note="~/.config/scripts/macos/mac/misc/300-dailyNote.sh"
...
script_selector="~/.config/scripts/macos/mac/misc/240-systemTask.sh"
...
if-shell 'test -f ~/.config/youtube-banner.txt' \
  'set -g @catppuccin_status_modules_right "directory"; \
