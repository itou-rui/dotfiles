...
const rules: KarabinerRules[] = [
    ...
    manipulators: [
      {
        ...
        to_if_alone: [
          {
            shell_command: `~/.config/scripts/macos/mac/misc/200-micMute.sh`,
          },
        ],
        type: "basic",
      },
  ...
  ...createHyperSubLayers({
    ...
    t: {
      ...
      //       shell_command: `~/.config/neovide/neovide-sessionizer.sh`,
      //       // shell_command:
      ...
      //   to: [
      //     {
      //       shell_command: `~/.config/scripts/macos/mac/misc/300-dailyNote.sh`,
      //     },
      //   ],
      // },
    ...
    o: {
        ...
        to: [
          {
            ...
            // ~/.config/scripts/macos/mac/260-obsSceneType.sh
            // to replace the shell command below depending on the type of
            // recording
            // lineid_obs_switchscene_main
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py main-1-guest`,
          },
        ],
      },
      s: {
        to: [
          {
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py starting-soon`,
          },
        ],
      },
      1: {
        to: [
          {
            ...
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py guest1-1guest`,
          },
        ],
      },
      2: {
        to: [
          {
            ...
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py `,
          },
        ],
      },
      3: {
      ...
      b: {
        to: [
          {
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py be-right-back`,
          },
        ],
      },
      t: {
        to: [
          {
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py tech-difficulties`,
          },
        ],
      },
      z: {
        to: [
          {
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py zoom-main`,
          },
        ],
      },
      //   k: {
        ...
        to: [
          {
            ...
            shell_command: `export PATH="/opt/homebrew/bin:$PATH" && python3 ~/.config/scripts/macos/mac/obs/scene-switcher/py/switch_scene.py guests-all-notes-right`,
          },
        ],
      },
    },
        ...
        to: [
          {
            ...
            shell_command: `~/.config/yabai/yabai_restart.sh`,
          },
        ],
      },
    ...
    left_command: {
      ...
      4: {
        to: [
          {
            shell_command: `~/.config/hidapitester/hidapitester --vidpid 046D:B020 --usagePage 0xFF43 --usage 0x0202 --open --length 20 --send-output 0x11,0x00,0x0C,0x1C,0x00`,
          },
        ],
      },
      ...
      5: {
        to: [
          {
            shell_command: `~/.config/hidapitester/hidapitester --vidpid 046D:B020 --usagePage 0xFF43 --usage 0x0202 --open --length 20 --send-output 0x11,0x00,0x0C,0x1C,0x01`,
          },
        ],
      },
      // Pull github repos
