...
# Filename: ~/.config/colorscheme/list/linkarzu-colors.sh
# ~/.config/colorscheme/list/linkarzu-colors.sh
...
linkarzu_color19=#2b4b90
# Markdown heading 3 - color03
linkarzu_color20=#566a93
# Markdown heading 4 - color01
linkarzu_color21=#999999
# Markdown heading 5 - color05
linkarzu_color22=#912e2f
