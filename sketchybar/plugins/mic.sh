...
# Filename: ~/.config/sketchybar/felixkratz-linkarzu/plugins/mic.sh
# ~/.config/sketchybar/felixkratz-linkarzu/plugins/mic.sh
...
# I'll be using this in ~/.config/scripts/macos/mac/misc/200-micMute.sh
