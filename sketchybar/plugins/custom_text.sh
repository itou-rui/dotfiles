...
# Filename: ~/.config/sketchybar/felixkratz-linkarzu/plugins/custom_text.sh
# ~/.config/sketchybar/felixkratz-linkarzu/plugins/custom_text.sh

source "$CONFIG_DIR/colors.sh"

# File created by ~/github/scripts-public/macos/mac/305-bannerOn.sh
youtube_banner="$HOME/.config/youtube-banner.txt"
