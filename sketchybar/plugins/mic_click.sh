...
# Filename: ~/.config/sketchybar/felixkratz-linkarzu/plugins/mic_click.sh
# ~/.config/sketchybar/felixkratz-linkarzu/plugins/mic_click.sh
...
# ~/.config/sketchybar/felixkratz/plugins/volume_click.sh
toggle_mics() {
