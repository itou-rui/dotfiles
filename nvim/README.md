...
```bash
# instead of this:
NVIM_APPNAME=linkarzu/dotfiles-latest/nvim nvim

# You would run this:
NVIM_APPNAME=linkarzu/dotfiles-latest/nvim /opt/homebrew/bin/nvim
```

- You can create an alias in your `.bashrc` or `.zshrc` file, just add this

```bash
alias neobean='NVIM_APPNAME=linkarzu/dotfiles-latest/nvim nvim'
```
